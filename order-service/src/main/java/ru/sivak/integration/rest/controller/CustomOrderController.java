...
public class CustomOrderController {
    ...
    public OrderDto create(@RequestBody CreateOrderRequest request) {
        ...
        return customOrderService.create(command.managerId(), command.carId(), command.price());
    }
    ...
    public OrderDto update(@PathVariable UUID id, @RequestBody UpdateOrderRequest request) {
        ...
        return customOrderService.update(command.orderId(), command.clientId(), command.carId(), command.price());
    }
